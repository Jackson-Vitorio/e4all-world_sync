<div align="center">
  <h1>e4all</h1>
  <p><b>A fork of e4mc that adds a toggle for Offline Mode.</b></p>
...
### The Core Difference: Offline Mode
**e4all is basically e4mc, but with one improvement: it allows you to enable or disable Offline Mode.**
