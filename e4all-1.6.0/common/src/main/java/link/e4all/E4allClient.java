...
import link.e4all.mundosync.MundoSyncCommands;
...
public class E4allClient {
    ...
    public static void registerCommands(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        // Register MundoSync commands separately to avoid loading client-only classes
        MundoSyncCommands.register(dispatcher);
    }
}